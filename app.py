...
# =========================================================
    ...
    with col1:
        # UPDATED IMAGE: Verified Pexels ID 5473180 (Woman of Color, Grey Zip-Up Hoodie)
        st.image(
            "https://images.pexels.com/photos/5473180/pexels-photo-5473180.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
